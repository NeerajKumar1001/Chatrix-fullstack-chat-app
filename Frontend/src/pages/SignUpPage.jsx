...
import { Squirrel, User, Eye, EyeOff, Loader2, Lock, Mail } from "lucide-react";
...
const SignUpPage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen w-full">
      {/* Left Panel */}
      <div className="bg-[#1a1a1a] flex flex-col justify-center items-center w-full  lg:w-1/2 h-[900px] lg:h-full px-6 py-10">
